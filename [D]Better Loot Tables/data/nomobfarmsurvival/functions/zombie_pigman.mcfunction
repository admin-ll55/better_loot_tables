...
execute as @e[type=zombie_pigman,distance=..5] run data merge entity @s {HandDropChances:[1.0f,1.0f],ArmorDropChances:[1.0f,1.0f,1.0f,1.0f]}
advancement revoke @s only nomobfarmsurvival:zombie_pigman